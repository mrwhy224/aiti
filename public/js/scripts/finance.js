$(function() {
	...
	loadAndBlockSection('.statistics-body', '/invoice/statistics', function (json) {
		$('.invoice_count').text(json.data.invoice_count)
		$('.company_count').text(json.data.company_count)
		$('.paid_money').text(json.data.paid_money)
		$('.unpaid_money').text(json.data.unpaid_money)
	});
